...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_task_task_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/task/task.service */ "./src/app/services/task/task.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TaskComponent = /** @class */ (function () {
    ...
    TaskComponent.prototype.deleteTask = function (id) {
        ...
        if (response) {
            ...
            this.taskService.deleteTask(id)
                ...
                if (data) {
                    _this.tasks = _this.tasks.filter(function (t) { return t._id !== id; });
                }
            });
        }
    };
    TaskComponent.prototype.updateStatus = function (task) {
        var newTask = Object.assign({}, task, { isDone: !task.isDone });
    ...
    TaskComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_services_task_task_service__WEBPACK_IMPORTED_MODULE_1__["TaskService"]]
        }),
        __metadata("design:paramtypes", [_services_task_task_service__WEBPACK_IMPORTED_MODULE_1__["TaskService"]])
    ], TaskComponent);
...
var TaskService = /** @class */ (function () {
    ...
    TaskService.prototype.updateTask = function (newTask) {
        return this.http.put("api/task/" + newTask._id, newTask)
            .map(function (res) { return res; });
    };
...
module.exports = __webpack_require__(/*! D:\Programacion\MEAN\mean-crud-tasks\src\client\src\main.ts */"./src/main.ts");
